...
namespace OpenALPRPlugin.Client
{
    ...
    /// </summary>
    public class OpenALPRViewItemPlugin : ViewItemPlugin
    {
        public OpenALPRViewItemPlugin()
        {
        }
        ...
        {
            get { return OpenALPRPluginDefinition.OpenALPRViewItemPlugin; }
        }

        public override Image Icon
        {
            get { return OpenALPRPluginDefinition.TreeNodeImage; }
        }
        ...
        {
            return new OpenALPRViewItemManager();
        }
    }
}
